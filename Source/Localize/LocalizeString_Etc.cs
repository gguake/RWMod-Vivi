namespace VVRace
{
    public static class LocalizeString_Etc
    {
        ...
        public const string VV_JobFailReasonNotVivi = nameof(VV_JobFailReasonNotVivi);
        ...
        public const string VV_ModSettings_UseVanillaHeadOnly = nameof(VV_ModSettings_UseVanillaHeadOnly);
        public const string VV_ModSettings_UseVanillaHeadOnlyDesc = nameof(VV_ModSettings_UseVanillaHeadOnlyDesc);
