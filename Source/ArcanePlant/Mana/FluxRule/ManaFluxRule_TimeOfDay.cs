...
namespace VVRace
{
    public class ManaFluxRule_TimeOfDay : ManaFluxRule
    {
        ...
        public override string GetRuleLabel()
        {
            ...
            {
                case TimeOfDay.Day:
                    return LocalizeString_Stat.VV_ManaFluxRuleLabel_TimeOfDayDay.Translate();

                case TimeOfDay.Night:
                    return LocalizeString_Stat.VV_ManaFluxRuleLabel_TimeOfDayNight.Translate();

                default:
                    return LocalizeString_Stat.VV_ManaFluxRuleLabel_Always.Translate();
            }
        }
